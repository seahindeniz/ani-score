...
function Toaster<T extends ValidComponent = 'ol'>(props: PolymorphicProps<T, ToastListProps<T>>) {
...
function Toast<T extends ValidComponent = 'li'>(props: PolymorphicProps<T, ToastRootProps<T>>) {
...
function ToastClose<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, ToastCloseButtonProps<T>>) {
...
function ToastTitle<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, ToastTitleProps<T>>) {
...
function ToastDescription<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, ToastDescriptionProps<T>>) {
